class Parking():
    ...
    def pay_for_parking(self):
        Q2 = int(input("Please Insert Exactly $25: "))
        self.total += Q2
        if Q2 >=25:
    ...
    def leave_garage(self):
            print("Thank you for using R & T's Parking Garage.")
    def showInstructions(self):
        print("""
Welcome to R & T's Parking Garage.
    ...
    def run(self):
        ...
        while True:
            ...
            if choice == "1":
                ...
                print("Please see the R & T's Attendant!")
